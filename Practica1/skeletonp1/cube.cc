...
_cube::_cube(float Size)
{
    ...
    Triangles[0]=_vertex3ui(2,0,4);
    Triangles[1]=_vertex3ui(2,6,4);
    Triangles[2]=_vertex3ui(3,1,0);
    Triangles[3]=_vertex3ui(3,2,0);
    Triangles[4]=_vertex3ui(6,4,5);
    Triangles[5]=_vertex3ui(6,7,5);
    Triangles[6]=_vertex3ui(7,5,1);
    Triangles[7]=_vertex3ui(7,3,1);

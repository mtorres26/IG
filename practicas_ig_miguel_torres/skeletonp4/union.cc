...
// Segundo elemento del modelo jerarquico, se transforma adecuadamente y llama al primer elemento
...
void _union::draw_flat_shading(float ajustar_altura_respaldo, float girar_asiento, float inclinar_asiento, float ajustar_altura_asiento)
{
    ...
    glPushMatrix();
        ...
        glScalef(1,ajustar_altura_respaldo,1);
        glScalef(0.1,1,0.1);
        soporte.draw_flat_shading();
    glPopMatrix();

    respaldo.draw_flat_shading(ajustar_altura_respaldo,girar_asiento,inclinar_asiento,ajustar_altura_asiento);


}

void _union::draw_smooth_shading(float ajustar_altura_respaldo, float girar_asiento, float inclinar_asiento, float ajustar_altura_asiento)
{
    ...
    glPushMatrix();
        ...
        glScalef(1,ajustar_altura_respaldo,1);
        glScalef(0.1,1,0.1);
        soporte.draw_smooth_shading();
    glPopMatrix();

    respaldo.draw_smooth_shading(ajustar_altura_respaldo,girar_asiento,inclinar_asiento,ajustar_altura_asiento);

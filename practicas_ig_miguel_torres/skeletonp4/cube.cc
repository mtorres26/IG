...
_cube::_cube(float Size)
{
    ...
    Triangles[0]=_vertex3ui(0,2,4);
    Triangles[1]=_vertex3ui(4,2,6);
    Triangles[2]=_vertex3ui(5,6,7);
    Triangles[3]=_vertex3ui(5,4,6);
    Triangles[4]=_vertex3ui(1,7,3);
    Triangles[5]=_vertex3ui(1,5,7);
    Triangles[6]=_vertex3ui(0,3,2);
    Triangles[7]=_vertex3ui(0,1,3);
    Triangles[8]=_vertex3ui(3,6,2);
    Triangles[9]=_vertex3ui(3,7,6);
    Triangles[10]=_vertex3ui(0,5,1);
    Triangles[11]=_vertex3ui(0,4,5);

...
// Tercer elemento del modelo jerarquico, se transforma adecuadamente y llama al segundo elemento el cual contiene a su vez al primero
...
void _seat::draw_flat_shading(float ajustar_altura_respaldo, float girar_asiento, float inclinar_asiento, float ajustar_altura_asiento)
{
    ...
    glPushMatrix();
        ...
        glRotatef(girar_asiento,0,1,0);
        glScalef(1,0.1,1);
        asiento.draw_flat_shading();
    glPopMatrix();

    soporte.draw_flat_shading(ajustar_altura_respaldo,girar_asiento,inclinar_asiento,ajustar_altura_asiento);


}

void _seat::draw_smooth_shading(float ajustar_altura_respaldo, float girar_asiento, float inclinar_asiento, float ajustar_altura_asiento)
{
    ...
    glPushMatrix();
        ...
        glRotatef(girar_asiento,0,1,0);
        glScalef(1,0.1,1);
        asiento.draw_smooth_shading();
    glPopMatrix();

    soporte.draw_smooth_shading(ajustar_altura_respaldo,girar_asiento,inclinar_asiento,ajustar_altura_asiento);

...
void _wheel::draw_flat_shading(float ajustar_altura_respaldo, float girar_asiento, float inclinar_asiento, float ajustar_altura_asiento)
{
    ...
    glPushMatrix();
        ...
        glRotatef(90,0,0,1);
        glRotatef(45,1,0,0);
        rueda_delantera_der.draw_flat_shading();
    glPopMatrix();
    ...
    glPushMatrix();
        ...
        glRotatef(90,0,0,1);
        glRotatef(-45,1,0,0);
        rueda_delantera_izq.draw_flat_shading();
    glPopMatrix();
    ...
    glPushMatrix();
        ...
        glRotatef(90,0,0,1);
        glRotatef(-45,1,0,0);
        rueda_trasera_der.draw_flat_shading();
    glPopMatrix();
    ...
    glPushMatrix();
        ...
        glRotatef(90,0,0,1);
        glRotatef(45,1,0,0);
        rueda_trasera_izq.draw_flat_shading();
    glPopMatrix();
...
void _wheel::draw_smooth_shading(float ajustar_altura_respaldo, float girar_asiento, float inclinar_asiento, float ajustar_altura_asiento)
{
    ...
    glPushMatrix();
        ...
        glRotatef(90,0,0,1);
        glRotatef(45,1,0,0);
        rueda_delantera_der.draw_smooth_shading();
    glPopMatrix();
    ...
    glPushMatrix();
        ...
        glRotatef(90,0,0,1);
        glRotatef(-45,1,0,0);
        rueda_delantera_izq.draw_smooth_shading();
    glPopMatrix();
    ...
    glPushMatrix();
        ...
        glRotatef(90,0,0,1);
        glRotatef(-45,1,0,0);
        rueda_trasera_der.draw_smooth_shading();
    glPopMatrix();
    ...
    glPushMatrix();
        ...
        glRotatef(90,0,0,1);
        glRotatef(45,1,0,0);
        rueda_trasera_izq.draw_smooth_shading();
    glPopMatrix();
